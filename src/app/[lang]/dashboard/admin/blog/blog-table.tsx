  ...
  const columns: ColumnDef<BlogPost>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <span className={`px-2 py-1 rounded text-xs ${published ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-muted/50 text-muted-foreground'}`}>
