...
export default async function ClientQuotationDetailPage({ params }: {
  ...
  // Para clientes, verificar que la cotización les pertenece
  const { data: quotation, error } = await supabase
    ...
    `)
    .eq('id', id)
    .eq('user_id', user.id) // Asegurar que solo vean sus propias cotizaciones
    .single()
