...
import type { NotificationMessage, RequiredMetatags } from "@/interfaces";

const NotFound = () => {
  const notificationMessageInfo: NotificationMessage = {
    topic: "404",
  ...
  const metatagsInfo: RequiredMetatags = {
    ...
    image:
      "https://res.cloudinary.com/https-imsoft-io/image/upload/v1706594670/imsoft-images/imsoft/logotipo-imsoft-cuadrado.png",
