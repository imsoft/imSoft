...
const SocialMediaCampainsPage = async ({
  ...
  const serviceFeatures =
    page.services.locations.cdmx.services.campaignsOnSocialNetworks.featuresSection.serviceFeatures.map(
  ...
  return (
    <>
      <main>
        <IntroductorySection
          title={
            page.services.locations.cdmx.services.campaignsOnSocialNetworks
