...
export const generateMetadata = async ({
  ...
  return {
    title: metadata.service.location.zapopan.mobileApps.title,
    description: metadata.service.location.zapopan.mobileApps.description,
    keywords: metadata.service.location.zapopan.mobileApps.keywords,
    twitter: {
      title: metadata.service.location.zapopan.mobileApps.twitter.title,
      description:
        metadata.service.location.zapopan.mobileApps.twitter.description,
    },
    openGraph: {
      title: metadata.service.location.zapopan.mobileApps.openGraph.title,
      description:
        metadata.service.location.zapopan.mobileApps.openGraph.description,
    },
  };
};
