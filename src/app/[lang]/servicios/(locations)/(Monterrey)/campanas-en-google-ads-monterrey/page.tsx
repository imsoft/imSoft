...
export const generateMetadata = async ({
  ...
  return {
    title: metadata.service.location.monterrey.campaignsInGoogleAds.title,
    description: metadata.service.location.monterrey.campaignsInGoogleAds.description,
    keywords: metadata.service.location.monterrey.campaignsInGoogleAds.keywords,
    twitter: {
      title: metadata.service.location.monterrey.campaignsInGoogleAds.twitter.title,
      description:
        metadata.service.location.monterrey.campaignsInGoogleAds.twitter.description,
    },
    openGraph: {
      title: metadata.service.location.monterrey.campaignsInGoogleAds.openGraph.title,
      description:
        metadata.service.location.monterrey.campaignsInGoogleAds.openGraph.description,
    },
  };
};
