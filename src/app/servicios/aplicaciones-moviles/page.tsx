...
export const metadata: Metadata = {
  ...
  const introductorySectionInfo: IIntroductorySection = {
    ...
    description:
      "Lleva tu negocio al siguiente nivel con aplicaciones móviles innovadoras, diseñadas para ofrecer la mejor experiencia a tus usuarios.",
  };
  ...
  const featuresSectionInfo: IFeaturesSection = {
    ...
    description:
      "Desarrollamos aplicaciones móviles que marcan la diferencia en la experiencia del usuario y el rendimiento empresarial",
    serviceFeatures: [
      {
        title: "Diseño UX/UI",
        description:
  ...
  const pricesSectionInfo: IPricesSection = {
    topic: "Aplicaciones Móviles",
    description: "Soluciones móviles personalizadas para impulsar tu negocio en la era digital",
    listOfPackages: [
      {
  ...
  const callToActionSectionInfo: ICallToActionSection = {
    ...
    topic: "Aplicaciones Móviles",
    title: "Innova y crece con aplicaciones móviles a medida",
    description:
      "Da el paso hacia la transformación digital con aplicaciones móviles que capturan la esencia de tu marca y conectan con tus usuarios. Contáctanos y descubre cómo podemos llevar tu idea a la realidad.",
  };
