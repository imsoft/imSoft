...
export const metadata: Metadata = {
  title: "Sitio Web Pro en Zapopan | imSoft",
  description:
    "Desarrollamos sitios web Pro en Zapopan, utilizando tecnología de vanguardia para crear soluciones web que impulsen tu negocio.",
  keywords: ["imSoft", "Sitio web Pro", "Desarrollo web avanzado Zapopan"],
  twitter: {
    title: "Sitio Web Pro en Zapopan | imSoft",
    description:
      "Lleva tu negocio en Zapopan a la vanguardia digital con nuestro servicio de Sitio Web Pro. Tecnología avanzada para un rendimiento superior.",
  },
  openGraph: {
    title: "Desarrollo de Sitio Web Pro en Zapopan | imSoft",
    description:
      "En imSoft, creamos sitios web Pro para negocios en Zapopan que buscan excelencia y rendimiento en el mundo digital.",
  },
};

const introductorySectionInfo: IIntroductorySection = {
  title: "Servicio de Sitio Web Pro en Zapopan",
  description:
    "Utilizamos las mejores tecnologías para llevar tu empresa en Zapopan al siguiente nivel. Un sitio web Pro significa más potencia, más velocidad y un diseño superior.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Sitio Web Pro para Negocios en Zapopan",
  title: "Características Avanzadas de Nuestros Sitios Web Pro",
  description:
    "Nuestros sitios web Pro están diseñados para empresas en Zapopan que buscan un rendimiento y una presencia online de primer nivel.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Paquetes de Sitio Web Pro para Zapopan",
  description:
    "Descubre nuestros paquetes de Sitio Web Pro, diseñados para satisfacer las necesidades de negocios dinámicos y ambiciosos en Zapopan.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Sitio Web Pro en Zapopan",
  title: "Eleva tu Negocio en Zapopan con un Sitio Web Pro",
  description:
    "Descubre el poder de un Sitio Web Pro con imSoft en Zapopan. Contacta con nosotros para soluciones web que transformen tu presencia digital.",
};
