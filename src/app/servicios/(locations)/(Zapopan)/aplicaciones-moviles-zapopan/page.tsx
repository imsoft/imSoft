...
const introductorySectionInfo: IIntroductorySection = {
  title: "Aplicaciones Móviles en Zapopan",
  description:
    "Lleva tu negocio en Zapopan al siguiente nivel con aplicaciones móviles innovadoras, diseñadas para ofrecer la mejor experiencia a tus usuarios locales.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Aplicaciones Móviles",
  title: "Soluciones Móviles en Zapopan",
  description:
    "Desarrollamos aplicaciones móviles que marcan la diferencia en Zapopan, mejorando la experiencia del usuario y el rendimiento empresarial.",
  serviceFeatures: [
    {
      title: "Diseño UX/UI",
      description:
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Aplicaciones Móviles para Zapopan",
  title: "Innova en Zapopan con Aplicaciones Móviles a Medida",
  description:
    "Transforma tu negocio en Zapopan con aplicaciones móviles que reflejan la esencia de tu marca y conectan con tus usuarios. Descubre cómo podemos llevar tu idea a la realidad.",
};
