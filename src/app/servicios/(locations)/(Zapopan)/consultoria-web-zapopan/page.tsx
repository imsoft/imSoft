...
const introductorySectionInfo: IIntroductorySection = {
  title: "Especialistas en Consultoría Web en Zapopan",
  description:
    "En imSoft, combinamos calidad y eficiencia para ofrecer soluciones de consultoría web que llevan a los negocios de Zapopan al siguiente nivel en el mundo digital.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Consultoría Web Localizada en Zapopan",
  title: "Características de Nuestro Servicio",
  description:
    "Ofrecemos un enfoque personalizado para maximizar el rendimiento y la productividad de su empresa en Zapopan, con soluciones de software a medida.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Paquetes de Consultoría Web en Zapopan",
  description:
    "Soluciones personalizadas de consultoría web para impulsar el crecimiento de tu negocio en Zapopan.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  description:
    "En imSoft, combinamos experiencia y conocimiento local para ofrecerte una consultoría web en Zapopan que cumpla y exceda tus expectativas.",
};
