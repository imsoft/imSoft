...
const introductorySectionInfo: IIntroductorySection = {
  title: "Expande tu Negocio en Zapopan con Nuestra Tienda en Línea",
  description:
    "Una tienda en línea es tu sucursal abierta 24/7 en Zapopan y más allá. Descubre el poder del comercio electrónico con imSoft.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Tienda en Línea para Zapopan",
  title: "Características de Nuestra Tienda en Línea",
  description:
    "Adapta tu empresa a la era digital con una tienda en línea diseñada para el mercado de Zapopan, ofreciendo accesibilidad y crecimiento global.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Soluciones de Tienda en Línea para Zapopan",
  description:
    "Ofrecemos paquetes de tienda en línea escalables y asequibles, ideales para negocios emergentes y establecidos en Zapopan.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Crea tu Tienda en Línea en Zapopan",
  title: "Lanza tu Tienda Online con imSoft",
  description:
    "Únete al mundo digital en Zapopan con una tienda en línea personalizada de imSoft. Contacta ahora y da el primer paso hacia el éxito en comercio electrónico.",
};
