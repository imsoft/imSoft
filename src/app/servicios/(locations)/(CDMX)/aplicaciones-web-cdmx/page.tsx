...
const introductorySectionInfo: IIntroductorySection = {
  title: "Desarrollo de Aplicaciones Web en CDMX",
  description:
...
const featuresSectionInfo: IFeaturesSection = {
  topic: "Aplicaciones Web en CDMX",
  title: "Características de Nuestro Servicio",
  description:
    "Eleva tu empresa en CDMX con aplicaciones web innovadoras que mejoran la eficiencia y la rentabilidad de tu negocio.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Soluciones de Aplicaciones Web en CDMX",
  description:
  ...
  listOfPackages: [
    {
      ...
      description:
        "Convierte tus ideas en realidad con soluciones a medida, diseñadas para el dinámico entorno empresarial de CDMX.",
      featuresOfPackage: [
        "Reunión inicial para alinear tus visiones y objetivos con las tendencias del mercado en CDMX.",
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Soluciones Web Personalizadas en CDMX",
  title: "Impulsa tu Negocio en CDMX con Aplicaciones Web a Medida",
  description:
    "Descubre cómo nuestras aplicaciones web pueden revolucionar tu negocio en CDMX. Mejora tu presencia en línea, interactúa de manera más efectiva con tus clientes locales, y automatiza tus procesos de negocio para una mayor eficiencia. Con nuestras soluciones, garantizamos aplicaciones web escalables y flexibles, diseñadas para evolucionar junto a tu empresa y las demandas del mercado de CDMX.",
};

const WebAppPageCDMX = () => {
  return (
    <>
      <main>
        <IntroductorySection
