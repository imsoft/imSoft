...
const introductorySectionInfo: IIntroductorySection = {
  title: "Análisis de Datos en CDMX",
  description:
    "Transformamos grandes volúmenes de datos en CDMX en información clara y accionable, adaptándonos a las necesidades de tu negocio local.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Análisis de Datos para CDMX",
  title: "Servicios personalizados de análisis de datos",
  description:
    "Optimiza tu estrategia empresarial con nuestro análisis de datos, enfocado en las dinámicas del mercado de CDMX.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Análisis de Datos en CDMX",
  title: "Impulsa tu negocio en CDMX con insights basados en datos",
  description:
    "Contáctanos para descubrir cómo nuestro enfoque específico para CDMX puede transformar tus datos en crecimiento empresarial.",
};
