...
const introductorySectionInfo: IIntroductorySection = {
  title: "Aplicaciones Móviles en CDMX",
  description:
    "Lleva tu negocio al siguiente nivel con aplicaciones móviles innovadoras en CDMX, diseñadas para ofrecer la mejor experiencia a tus usuarios locales.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Aplicaciones Móviles",
  title: "Servicios de Desarrollo en CDMX",
  description:
    "Desarrollamos aplicaciones móviles que marcan la diferencia en la experiencia del usuario y el rendimiento empresarial, adaptadas a las necesidades del mercado de CDMX.",
  serviceFeatures: [
    {
      title: "Diseño UX/UI",
      description:
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Aplicaciones Móviles en CDMX",
  title: "Innova y crece con aplicaciones móviles a medida en CDMX",
  description:
    "Da el paso hacia la transformación digital con aplicaciones móviles que capturan la esencia de tu marca y conectan con tus usuarios en CDMX. Contáctanos y descubre cómo podemos llevar tu idea a la realidad.",
};
