...
export const metadata: Metadata = {
  title: "Consultoría Web en CDMX | imSoft",
  description:
    "Expertos en consultoría web en CDMX, ofreciendo soluciones personalizadas para el desarrollo de sitios y aplicaciones web. Nuestro equipo experto está listo para elevar la presencia online de tu negocio.",
  keywords: [
    "imSoft",
    "Consultoría web",
  ...
  twitter: {
    title: "Consultoría Web en CDMX por imSoft",
    description:
      "Descubre cómo nuestra consultoría web en CDMX puede transformar tu negocio, optimizando tu sitio y aplicaciones web para el éxito.",
  },
  openGraph: {
    title: "Servicios de Consultoría Web en CDMX | imSoft",
    description:
      "En imSoft, brindamos consultoría web especializada en CDMX, asegurando que tu sitio web y aplicaciones estén alineados con tus objetivos empresariales.",
  },
};

const introductorySectionInfo: IIntroductorySection = {
  title: "Especialistas en Consultoría Web en CDMX",
  description:
    "En imSoft, combinamos calidad y eficiencia para ofrecer soluciones de consultoría web que llevan a los negocios de CDMX al siguiente nivel en el mundo digital.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Consultoría Web Localizada en CDMX",
  title: "Características de Nuestro Servicio",
  description:
    "Ofrecemos un enfoque personalizado para maximizar el rendimiento y la productividad de su empresa en CDMX, con soluciones de software a medida.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Paquete de Consultoría Web en CDMX",
  description:
    "Soluciones personalizadas de consultoría web para impulsar el crecimiento de tu negocio en CDMX.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Consultoría Web Profesional en CDMX",
  title: "Eleva tu Negocio en CDMX con Nuestra Consultoría Web",
  description:
    "En imSoft, combinamos experiencia y conocimiento local para ofrecerte una consultoría web en CDMX que cumpla y exceda tus expectativas.",
};
