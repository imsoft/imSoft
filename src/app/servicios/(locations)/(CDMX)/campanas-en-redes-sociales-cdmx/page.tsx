...
const introductorySectionInfo: IIntroductorySection = {
  title: "Campañas de Redes Sociales en CDMX",
  description:
    "Conecta con tu audiencia en CDMX y potencia tu marca con campañas creativas y estratégicas diseñadas para el mercado local.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Campañas de Redes Sociales Locales",
  title: "Servicios enfocados en CDMX",
  description:
    "Desarrollamos campañas de redes sociales con un enfoque local, aumentando el engagement y las conversiones en CDMX mediante estrategias y contenidos adaptados.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Campañas de Redes Sociales en CDMX",
  title: "Eleva tu Estrategia Digital Local",
  description:
    "Da el próximo paso para destacar tu marca en CDMX. Con nuestras campañas de redes sociales, conecta de manera auténtica con tu audiencia local y ve más allá de las expectativas.",
};
