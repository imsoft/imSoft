...
export const metadata: Metadata = {
  title: "Servicios de SEO en CDMX | imSoft",
  description:
    "Optimiza tu presencia online en CDMX con nuestros servicios de SEO. Estrategias personalizadas para impulsar tu negocio en los resultados de búsqueda de Google.",
  keywords: [
    "imSoft",
    "SEO CDMX",
    "Posicionamiento SEO CDMX",
    "Servicios SEO CDMX",
    "Análisis de palabras clave",
  ],
  twitter: {
    title: "SEO en CDMX | imSoft",
    description:
      "Aumenta la visibilidad de tu negocio en CDMX con nuestro SEO especializado. Estrategias y técnicas para dominar los resultados de Google.",
  },
  openGraph: {
    title: "Optimización SEO en CDMX | imSoft",
    description:
      "Con nuestros servicios de SEO en CDMX, tu negocio alcanzará nuevas alturas en el mundo digital. Contáctanos para mejorar tu ranking en Google.",
  },
};

const introductorySectionInfo: IIntroductorySection = {
  title: "Expertos en SEO en CDMX",
  description:
    "Lleguemos juntos a las primeras posiciones de Google y eleva tu negocio en CDMX con nuestro SEO avanzado y personalizado.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "SEO Avanzado en CDMX",
  title: "Cómo Potenciamos tu Negocio con SEO",
  description:
    "Maximiza tu presencia online en CDMX con nuestro servicio de SEO. Descubre cómo podemos llevar tu negocio al top de Google.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Precios de Servicios SEO en CDMX",
  description:
    "Descubre nuestros paquetes de SEO en CDMX y cómo pueden ayudar a tu negocio a crecer en el mundo digital.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "SEO para tu Negocio en CDMX",
  title: "Impulsa tu Presencia Online en CDMX",
  description:
    "Con nuestros servicios de SEO en CDMX, tu sitio web no solo alcanzará nuevos clientes, sino que también aumentará sus ventas en línea. Contáctanos y comienza a destacar en el mundo digital.",
};
