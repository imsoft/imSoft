...
export const metadata: Metadata = {
  ...
  description: "En imSoft ofrecemos servicios de diseño y desarrollo web personalizados en Tlaquepaque. Creamos sitios web responsivos, atractivos y optimizados para SEO, asegurando la mejor presencia online para tu negocio. Contáctanos para transformar tus ideas en una realidad digital exitosa.",
  keywords: [
  ...
  twitter: {
    ...
    description: "Transforma tu negocio con nuestros servicios de desarrollo y diseño web en Tlaquepaque. Sitios web personalizados, optimizados para SEO y listos para competir en el mercado digital. ¡Contáctanos y empieza tu proyecto hoy!",
  },
  openGraph: {
    title: "Servicios de Desarrollo Web en Tlaquepaque | imSoft",
    description: "Potencia tu negocio en línea con soluciones web a medida en Tlaquepaque. En imSoft, ofrecemos diseño, desarrollo, SEO y más para asegurar el éxito de tu proyecto en internet. Contáctanos para saber más.",
  },
};

const serviceCardInfo: IServiceCard[] = [
  {
    name: "Consultoria de sitio web en Tlaquepaque 🤓",
    description:
    ...
    imageAlt: "Consultoria de sitio web en Tlaquepaque 🤓 - imSoft",
    href: "/servicios/consultoria-web",
  },
  {
    name: "Sitio Web en Tlaquepaque 👨‍💻",
    description:
    ...
    imageAlt: "Sitio Web en Tlaquepaque 👨‍💻 - imSoft",
    href: "/servicios/sitio-web",
  },
  {
    name: "Tienda en línea en Tlaquepaque 🛍️",
    description:
    ...
    imageAlt: "Tienda en línea en Tlaquepaque 🛍️ - imSoft",
    href: "/servicios/tienda-en-linea",
  },
  {
    name: "Posicionamiento SEO en Tlaquepaque 🔝",
    description:
    ...
    imageAlt: "Posicionamiento SEO en Tlaquepaque 🔝 - imSoft",
    href: "/servicios/posicionamiento-seo",
  },
  {
    name: "Aplicación Web en Tlaquepaque 💻",
    description:
    ...
    imageAlt: "Aplicación Web en Tlaquepaque 💻 - imSoft",
    href: "/servicios/aplicaciones-web",
  },
  {
    name: "Análisis de datos en Tlaquepaque 📊",
    description:
    ...
    imageAlt: "Análisis de datos en Tlaquepaque 📊 - imSoft",
    href: "/servicios/analisis-de-datos",
  },
  {
    name: "Aplicaciones Móviles en Tlaquepaque 📱",
    description:
    ...
    imageAlt: "Aplicaciones Móviles en Tlaquepaque 📱 - imSoft",
    href: "/servicios/aplicaciones-moviles",
  },
  {
    name: "Campañas de redes sociales en Tlaquepaque 📲",
    description:
    ...
    imageAlt: "Campañas de redes sociales en Tlaquepaque 📲 - imSoft",
    href: "/servicios/campanas-en-redes-sociales",
  },
  {
    name: "Gestión de redes sociales en Tlaquepaque 🖼️",
    description:
    ...
    imageAlt: "Gestión de redes sociales en Tlaquepaque 🖼️ - imSoft",
    href: "/servicios/gestion-de-redes-sociales",
  },
  {
    name: "Campañas de Google Ads en Tlaquepaque 📣",
    description:
    ...
    imageAlt: "Campañas de Google Ads en Tlaquepaque 📣 - imSoft",
      ...
      <main>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-12">
            ...
            >
              Nuestros Servicios en Tlaquepaque
            </h2>
