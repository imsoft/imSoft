...
export const metadata: Metadata = {
  ...
  description: "En imSoft ofrecemos servicios de diseño y desarrollo web personalizados en Guadalajara. Creamos sitios web responsivos, atractivos y optimizados para SEO, asegurando la mejor presencia online para tu negocio. Contáctanos para transformar tus ideas en una realidad digital exitosa.",
  keywords: [
  ...
  twitter: {
    ...
    description: "Transforma tu negocio con nuestros servicios de desarrollo y diseño web en Guadalajara. Sitios web personalizados, optimizados para SEO y listos para competir en el mercado digital. ¡Contáctanos y empieza tu proyecto hoy!",
  },
  openGraph: {
    title: "Servicios de Desarrollo Web en Guadalajara | imSoft",
    description: "Potencia tu negocio en línea con soluciones web a medida en Guadalajara. En imSoft, ofrecemos diseño, desarrollo, SEO y más para asegurar el éxito de tu proyecto en internet. Contáctanos para saber más.",
  },
};

const serviceCardInfo: IServiceCard[] = [
  {
    name: "Consultoria de sitio web en Guadalajara 🤓",
    description:
    ...
    imageAlt: "Consultoria de sitio web en Guadalajara 🤓 - imSoft",
    href: "/servicios/consultoria-web",
  },
  {
    name: "Sitio Web en Guadalajara 👨‍💻",
    description:
    ...
    imageAlt: "Sitio Web en Guadalajara 👨‍💻 - imSoft",
    href: "/servicios/sitio-web",
  },
  {
    name: "Tienda en línea en Guadalajara 🛍️",
    description:
    ...
    imageAlt: "Tienda en línea en Guadalajara 🛍️ - imSoft",
    href: "/servicios/tienda-en-linea",
  },
  {
    name: "Posicionamiento SEO en Guadalajara 🔝",
    description:
    ...
    imageAlt: "Posicionamiento SEO en Guadalajara 🔝 - imSoft",
    href: "/servicios/posicionamiento-seo",
  },
  {
    name: "Aplicación Web en Guadalajara 💻",
    description:
    ...
    imageAlt: "Aplicación Web en Guadalajara 💻 - imSoft",
    href: "/servicios/aplicaciones-web",
  },
  {
    name: "Análisis de datos en Guadalajara 📊",
    description:
    ...
    imageAlt: "Análisis de datos en Guadalajara 📊 - imSoft",
    href: "/servicios/analisis-de-datos",
  },
  {
    name: "Aplicaciones Móviles en Guadalajara 📱",
    description:
    ...
    imageAlt: "Aplicaciones Móviles en Guadalajara 📱 - imSoft",
    href: "/servicios/aplicaciones-moviles",
  },
  {
    name: "Campañas de redes sociales en Guadalajara 📲",
    description:
    ...
    imageAlt: "Campañas de redes sociales en Guadalajara 📲 - imSoft",
    href: "/servicios/campanas-en-redes-sociales",
  },
  {
    name: "Gestión de redes sociales en Guadalajara 🖼️",
    description:
    ...
    imageAlt: "Gestión de redes sociales en Guadalajara 🖼️ - imSoft",
    href: "/servicios/gestion-de-redes-sociales",
  },
  {
    name: "Campañas de Google Ads en Guadalajara 📣",
    description:
    ...
    imageAlt: "Campañas de Google Ads en Guadalajara 📣 - imSoft",
      ...
      <main>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-12">
            ...
            >
              Nuestros Servicios en Guadalajara
            </h2>
