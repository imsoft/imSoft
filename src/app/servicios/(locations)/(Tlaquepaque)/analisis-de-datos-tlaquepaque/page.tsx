...
const introductorySectionInfo: IIntroductorySection = {
  title: "Análisis de Datos en Tlaquepaque",
  description:
    "Transforma grandes volúmenes de datos en Tlaquepaque en decisiones estratégicas con nuestro avanzado servicio de análisis.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Análisis de Datos",
  title: "Servicios de Análisis de Datos en Tlaquepaque",
  description:
    "En Tlaquepaque, optimiza tu toma de decisiones y estrategia empresarial con nuestro análisis de datos avanzado.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Análisis de Datos en Tlaquepaque",
  title: "Impulsa tu negocio en Tlaquepaque con insights basados en datos",
  description:
    "En Tlaquepaque, aprovecha el poder del análisis de datos para optimizar tus operaciones y liderar el mercado. Contáctanos para transformar tus datos en crecimiento.",
};
