...
const introductorySectionInfo: IIntroductorySection = {
  title: "Desarrollo de Sitio Web Profesional en Tlaquepaque",
  description:
    "Ya diste el primer paso hacia el éxito digital. Permítenos en imSoft acompañarte en el siguiente, creando un sitio web que destaque tu negocio en Tlaquepaque.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Sitio Web Personalizado para Tlaquepaque",
  title: "Características de Nuestros Sitios Web",
  description:
    "Ofrecemos sitios web personalizados para empresas en Tlaquepaque, diseñados para aumentar tu alcance y potenciar tus ventas en línea.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Paquetes de Sitio Web para Negocios en Tlaquepaque",
  description:
    "Ofrecemos paquetes de desarrollo web asequibles y personalizados, perfectos para empresas emergentes y establecidas en Tlaquepaque.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Desarrollo de Sitio Web en Tlaquepaque",
  title: "Crea tu Presencia Online en Tlaquepaque",
  description:
    "Eleva tu negocio en Tlaquepaque al mundo digital con un sitio web atractivo y funcional de imSoft. Contáctanos y comienza a transformar tu presencia en línea.",
};
