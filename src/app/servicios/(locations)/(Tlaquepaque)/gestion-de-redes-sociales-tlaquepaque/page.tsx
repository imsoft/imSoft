...
const introductorySectionInfo: IIntroductorySection = {
  title: "Gestión de Redes Sociales en Tlaquepaque",
  description:
    "Mantén una presencia vibrante en redes sociales con nuestro servicio integral, diseñado para conectar y convertir en Tlaquepaque.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Gestión de Redes Sociales en Tlaquepaque",
  title: "Servicios de Gestión en Redes Sociales",
  description:
    "Desde la creación de contenido hasta el análisis de resultados, adaptamos nuestra gestión para que tu marca brille en Tlaquepaque.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Gestión de Redes Sociales para Tlaquepaque",
  title: "Fortalece tu Marca en Redes Sociales en Tlaquepaque",
  description:
    "Transforma tu presencia en línea con estrategias personalizadas que reflejen la esencia de tu marca en Tlaquepaque. Comienza hoy y descubre el impacto de una gestión profesional.",
};
