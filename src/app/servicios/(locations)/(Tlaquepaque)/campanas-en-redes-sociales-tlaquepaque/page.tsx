...
const introductorySectionInfo: IIntroductorySection = {
  title: "Campañas de Redes Sociales en Tlaquepaque",
  description:
    "Conecta con tu audiencia en Tlaquepaque y potencia tu marca con campañas creativas y estratégicas diseñadas para el entorno digital local.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Campañas de Redes Sociales en Tlaquepaque",
  title: "Características de Nuestro Servicio Localizado",
  description:
    "Desarrollamos campañas de redes sociales en Tlaquepaque enfocadas en el engagement y la conversión, utilizando tendencias digitales y análisis de datos localizados.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Campañas de Redes Sociales en Tlaquepaque",
  title: "Transforma tu Presencia Digital en Tlaquepaque",
  description:
    "Inicia tu campaña de redes sociales en Tlaquepaque con imSoft y conecta de manera auténtica y memorable con tu audiencia local.",
};
