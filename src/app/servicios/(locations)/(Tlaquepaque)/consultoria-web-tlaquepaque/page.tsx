...
const introductorySectionInfo: IIntroductorySection = {
  title: "Especialistas en Consultoría Web en Tlaquepaque",
  description:
    "En imSoft, combinamos calidad y eficiencia para ofrecer soluciones de consultoría web que llevan a los negocios de Tlaquepaque al siguiente nivel en el mundo digital.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Consultoría Web Localizada en Tlaquepaque",
  title: "Características de Nuestro Servicio",
  description:
    "Ofrecemos un enfoque personalizado para maximizar el rendimiento y la productividad de su empresa en Tlaquepaque, con soluciones de software a medida.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Consultoría Web Profesional en Tlaquepaque",
  title: "Eleva tu Negocio en Tlaquepaque con Nuestra Consultoría Web",
  description:
    "En imSoft, combinamos experiencia y conocimiento local para ofrecerte una consultoría web en Tlaquepaque que cumpla y exceda tus expectativas.",
};
