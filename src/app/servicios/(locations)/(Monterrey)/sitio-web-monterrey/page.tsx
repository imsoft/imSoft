...
export const metadata: Metadata = {
  title: "Desarrollo de Sitio Web en Monterrey | imSoft",
  description:
    "En imSoft, creamos sitios web atractivos y funcionales para negocios en Monterrey. Contáctanos para darle a tu negocio una sólida presencia en línea.",
  keywords: [
    "imSoft",
    "Sitio web",
  ...
  twitter: {
    title: "Sitio Web en Monterrey | imSoft",
    description:
      "Lleva tu negocio en Monterrey al mundo digital con un sitio web atractivo y funcional. En imSoft, estamos listos para ayudarte a alcanzar tus objetivos digitales.",
  },
  openGraph: {
    title: "Desarrollo de Sitio Web en Monterrey | imSoft",
    description:
      "¿Necesitas un sitio web para tu negocio en Monterrey? En imSoft, diseñamos y desarrollamos soluciones web que se adaptan a tus necesidades.",
  },
};

const introductorySectionInfo: IIntroductorySection = {
  title: "Desarrollo de Sitio Web Profesional en Monterrey",
  description:
    "Ya diste el primer paso hacia el éxito digital. Permítenos en imSoft acompañarte en el siguiente, creando un sitio web que destaque tu negocio en Monterrey.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Sitio Web Personalizado para Monterrey",
  title: "Características de Nuestros Sitios Web",
  description:
    "Ofrecemos sitios web personalizados para empresas en Monterrey, diseñados para aumentar tu alcance y potenciar tus ventas en línea.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Paquete de Sitio Web para Negocios en Monterrey",
  description:
    "Ofrecemos paquetes de desarrollo web asequibles y personalizados, perfectos para empresas emergentes y establecidas en Monterrey.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Desarrollo de Sitio Web en Monterrey",
  title: "Crea tu Presencia Online en Monterrey",
  description:
    "Eleva tu negocio en Monterrey al mundo digital con un sitio web atractivo y funcional de imSoft. Contáctanos y comienza a transformar tu presencia en línea.",
};
