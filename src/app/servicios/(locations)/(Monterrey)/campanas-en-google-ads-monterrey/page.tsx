...
const introductorySectionInfo: IIntroductorySection = {
  title: "Campañas en Google Ads en Monterrey",
  description:
    "Impulsa tu negocio en Monterrey con campañas de Google Ads optimizadas para captar tu audiencia local y convertir clics en clientes.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Campañas de Google Ads para Monterrey",
  title: "Servicios adaptados a tu mercado local",
  description:
    "Maximiza cada clic con campañas en Google Ads diseñadas para el mercado de Monterrey, entregando resultados medibles y un impacto real en tu negocio local.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Campañas en Google Ads para Monterrey",
  title: "Eleva tu negocio local con Google Ads",
  description:
    "Únete a las empresas exitosas de Monterrey que utilizan Google Ads para crecer. Descubre cómo nuestras campañas personalizadas pueden llevar tu negocio local al próximo nivel.",
};
