...
const introductorySectionInfo: IIntroductorySection = {
  title: "Expande tu Negocio en Monterrey con Nuestra Tienda en Línea",
  description:
    "Una tienda en línea es tu sucursal abierta 24/7 en Monterrey y más allá. Descubre el poder del comercio electrónico con imSoft.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Tienda en Línea para Monterrey",
  title: "Características de Nuestra Tienda en Línea",
  description:
    "Adapta tu empresa a la era digital con una tienda en línea diseñada para el mercado de Monterrey, ofreciendo accesibilidad y crecimiento global.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Soluciones de Tienda en Línea para Monterrey",
  description:
    "Ofrecemos paquetes de tienda en línea escalables y asequibles, ideales para negocios emergentes y establecidos en Monterrey.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Crea tu Tienda en Línea en Monterrey",
  title: "Lanza tu Tienda Online con imSoft",
  description:
    "Únete al mundo digital en Monterrey con una tienda en línea personalizada de imSoft. Contacta ahora y da el primer paso hacia el éxito en comercio electrónico.",
};
