...
export const metadata: Metadata = {
  title: "Desarrollo de Aplicaciones Móviles en Monterrey | imSoft",
  description:
    "Especialistas en desarrollo de aplicaciones móviles a medida en Monterrey, diseñadas para impulsar el engagement de los usuarios y contribuir al crecimiento de tu negocio local.",
  keywords: [
    "imSoft",
    "Aplicaciones móviles en Monterrey",
...
const introductorySectionInfo: IIntroductorySection = {
  title: "Aplicaciones Móviles en Monterrey",
  description:
    "Lleva tu negocio al siguiente nivel con aplicaciones móviles innovadoras en Monterrey, diseñadas para ofrecer la mejor experiencia a tus usuarios locales.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Aplicaciones Móviles",
  title: "Servicios de Desarrollo en Monterrey",
  description:
    "Desarrollamos aplicaciones móviles que marcan la diferencia en la experiencia del usuario y el rendimiento empresarial, adaptadas a las necesidades del mercado de Monterrey.",
  serviceFeatures: [
    {
      title: "Diseño UX/UI",
      description:
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Aplicaciones Móviles en Monterrey",
  title: "Innova y crece con aplicaciones móviles a medida en Monterrey",
  description:
    "Da el paso hacia la transformación digital con aplicaciones móviles que capturan la esencia de tu marca y conectan con tus usuarios en Monterrey. Contáctanos y descubre cómo podemos llevar tu idea a la realidad.",
};
