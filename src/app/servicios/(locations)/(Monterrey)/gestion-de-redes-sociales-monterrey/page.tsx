...
const introductorySectionInfo: IIntroductorySection = {
  title: "Gestión de Redes Sociales en Monterrey",
  description:
    "Aprovecha nuestro servicio integral para destacar tu marca en las redes sociales de Monterrey, conectando auténticamente con tu audiencia local.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Gestión de Redes Sociales en Monterrey",
  title: "Servicios adaptados a tu audiencia local",
  description:
    "Nuestro enfoque está diseñado para resonar con la comunidad de Monterrey, desde la creación de contenido hasta la interacción y el análisis de resultados.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Gestión de Redes Sociales para Monterrey",
  title: "Conecta con tu audiencia en Monterrey",
  description:
    "Descubre el impacto de una gestión profesional de redes sociales enfocada en Monterrey. Transformamos tu presencia en línea para destacar en el mercado local.",
};
