...
export const metadata: Metadata = {
  title: "Gestión de Campañas de Redes Sociales en Monterrey | imSoft",
  description:
    "Maximiza tu impacto en Monterrey con nuestras campañas de redes sociales personalizadas. Aumenta la visibilidad y el engagement de tu marca localmente.",
  keywords: [
    "imSoft",
    "Campañas de Redes Sociales en Monterrey",
    "Marketing Digital Monterrey",
    "Engagement Monterrey",
  ],
  twitter: {
...
const introductorySectionInfo: IIntroductorySection = {
  title: "Campañas de Redes Sociales en Monterrey",
  description:
    "Conecta con tu audiencia en Monterrey y potencia tu marca con campañas creativas y estratégicas diseñadas para el mercado local.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Campañas de Redes Sociales Locales",
  title: "Servicios enfocados en Monterrey",
  description:
    "Desarrollamos campañas de redes sociales con un enfoque local, aumentando el engagement y las conversiones en Monterrey mediante estrategias y contenidos adaptados.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Campañas de Redes Sociales en Monterrey",
  title: "Eleva tu Estrategia Digital Local",
  description:
    "Da el próximo paso para destacar tu marca en Monterrey. Con nuestras campañas de redes sociales, conecta de manera auténtica con tu audiencia local y ve más allá de las expectativas.",
};
