...
export const metadata: Metadata = {
  ...
  description: "En imSoft ofrecemos servicios de diseño y desarrollo web personalizados en Zapopan. Creamos sitios web responsivos, atractivos y optimizados para SEO, asegurando la mejor presencia online para tu negocio. Contáctanos para transformar tus ideas en una realidad digital exitosa.",
  keywords: [
  ...
  twitter: {
    ...
    description: "Transforma tu negocio con nuestros servicios de desarrollo y diseño web en Zapopan. Sitios web personalizados, optimizados para SEO y listos para competir en el mercado digital. ¡Contáctanos y empieza tu proyecto hoy!",
  },
  openGraph: {
    title: "Servicios de Desarrollo Web en Zapopan | imSoft",
    description: "Potencia tu negocio en línea con soluciones web a medida en Zapopan. En imSoft, ofrecemos diseño, desarrollo, SEO y más para asegurar el éxito de tu proyecto en internet. Contáctanos para saber más.",
  },
};

const serviceCardInfo: IServiceCard[] = [
  {
    name: "Consultoria de sitio web en Zapopan 🤓",
    description:
    ...
    imageAlt: "Consultoria de sitio web en Zapopan 🤓 - imSoft",
    href: "/servicios/consultoria-web",
  },
  {
    name: "Sitio Web en Zapopan 👨‍💻",
    description:
    ...
    imageAlt: "Sitio Web en Zapopan 👨‍💻 - imSoft",
    href: "/servicios/sitio-web",
  },
  {
    name: "Tienda en línea en Zapopan 🛍️",
    description:
    ...
    imageAlt: "Tienda en línea en Zapopan 🛍️ - imSoft",
    href: "/servicios/tienda-en-linea",
  },
  {
    name: "Posicionamiento SEO en Zapopan 🔝",
    description:
    ...
    imageAlt: "Posicionamiento SEO en Zapopan 🔝 - imSoft",
    href: "/servicios/posicionamiento-seo",
  },
  {
    name: "Aplicación Web en Zapopan 💻",
    description:
    ...
    imageAlt: "Aplicación Web en Zapopan 💻 - imSoft",
    href: "/servicios/aplicaciones-web",
  },
  {
    name: "Análisis de datos en Zapopan 📊",
    description:
    ...
    imageAlt: "Análisis de datos en Zapopan 📊 - imSoft",
    href: "/servicios/analisis-de-datos",
  },
  {
    name: "Aplicaciones Móviles en Zapopan 📱",
    description:
    ...
    imageAlt: "Aplicaciones Móviles en Zapopan 📱 - imSoft",
    href: "/servicios/aplicaciones-moviles",
  },
  {
    name: "Campañas de redes sociales en Zapopan 📲",
    description:
    ...
    imageAlt: "Campañas de redes sociales en Zapopan 📲 - imSoft",
    href: "/servicios/campanas-en-redes-sociales",
  },
  {
    name: "Gestión de redes sociales en Zapopan 🖼️",
    description:
    ...
    imageAlt: "Gestión de redes sociales en Zapopan 🖼️ - imSoft",
    href: "/servicios/gestion-de-redes-sociales",
  },
  {
    name: "Campañas de Google Ads en Zapopan 📣",
    description:
    ...
    imageAlt: "Campañas de Google Ads en Zapopan 📣 - imSoft",
