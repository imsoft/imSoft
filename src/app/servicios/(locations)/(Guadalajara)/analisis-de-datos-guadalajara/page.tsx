...
const introductorySectionInfo: IIntroductorySection = {
  title: "Análisis de Datos en Guadalajara",
  description:
    "Transformamos grandes volúmenes de datos en Guadalajara en información clara y accionable, adaptándonos a las necesidades de tu negocio local.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Análisis de Datos para Guadalajara",
  title: "Servicios personalizados de análisis de datos",
  description:
    "Optimiza tu estrategia empresarial con nuestro análisis de datos, enfocado en las dinámicas del mercado de Guadalajara.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Análisis de Datos en Guadalajara",
  title: "Impulsa tu negocio en Guadalajara con insights basados en datos",
  description:
    "Contáctanos para descubrir cómo nuestro enfoque específico para Guadalajara puede transformar tus datos en crecimiento empresarial.",
};
