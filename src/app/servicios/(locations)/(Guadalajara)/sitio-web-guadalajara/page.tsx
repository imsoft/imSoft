...
const introductorySectionInfo: IIntroductorySection = {
  title: "Desarrollo de Sitio Web Profesional en Guadalajara",
  description:
    "Ya diste el primer paso hacia el éxito digital. Permítenos en imSoft acompañarte en el siguiente, creando un sitio web que destaque tu negocio en Guadalajara.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Sitio Web Personalizado para Guadalajara",
  title: "Características de Nuestros Sitios Web",
  description:
    "Ofrecemos sitios web personalizados para empresas en Guadalajara, diseñados para aumentar tu alcance y potenciar tus ventas en línea.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Paquetes de Sitio Web para Negocios en Guadalajara",
  description:
    "Ofrecemos paquetes de desarrollo web asequibles y personalizados, perfectos para empresas emergentes y establecidas en Guadalajara.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Desarrollo de Sitio Web en Guadalajara",
  title: "Crea tu Presencia Online en Guadalajara",
  description:
    "Eleva tu negocio en Guadalajara al mundo digital con un sitio web atractivo y funcional de imSoft. Contáctanos y comienza a transformar tu presencia en línea.",
};
