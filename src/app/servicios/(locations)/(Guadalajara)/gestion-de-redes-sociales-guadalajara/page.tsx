...
const introductorySectionInfo: IIntroductorySection = {
  title: "Gestión de Redes Sociales en Guadalajara",
  description:
    "Aprovecha nuestro servicio integral para destacar tu marca en las redes sociales de Guadalajara, conectando auténticamente con tu audiencia local.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Gestión de Redes Sociales en Guadalajara",
  title: "Servicios adaptados a tu audiencia local",
  description:
    "Nuestro enfoque está diseñado para resonar con la comunidad de Guadalajara, desde la creación de contenido hasta la interacción y el análisis de resultados.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Gestión de Redes Sociales para Guadalajara",
  title: "Conecta con tu audiencia en Guadalajara",
  description:
    "Descubre el impacto de una gestión profesional de redes sociales enfocada en Guadalajara. Transformamos tu presencia en línea para destacar en el mercado local.",
};
