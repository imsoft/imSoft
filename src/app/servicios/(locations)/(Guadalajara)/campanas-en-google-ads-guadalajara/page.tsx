...
export const metadata: Metadata = {
  title: "Gestión de Campañas en Google Ads en Guadalajara | imSoft",
  description:
    "Optimiza tu inversión en Guadalajara con campañas personalizadas de Google Ads. Mejoramos tu visibilidad, atraemos tráfico de calidad y aumentamos las conversiones localmente.",
  keywords: [
    "imSoft",
    "Google Ads en Guadalajara",
    "Campañas PPC Guadalajara",
    "Publicidad en línea Guadalajara",
    "SEM Guadalajara",
  ],
  twitter: {
...
const introductorySectionInfo: IIntroductorySection = {
  title: "Campañas en Google Ads en Guadalajara",
  description:
    "Impulsa tu negocio en Guadalajara con campañas de Google Ads optimizadas para captar tu audiencia local y convertir clics en clientes.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Campañas de Google Ads para Guadalajara",
  title: "Servicios adaptados a tu mercado local",
  description:
    "Maximiza cada clic con campañas en Google Ads diseñadas para el mercado de Guadalajara, entregando resultados medibles y un impacto real en tu negocio local.",
  serviceFeatures: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Campañas en Google Ads para Guadalajara",
  title: "Eleva tu negocio local con Google Ads",
  description:
    "Únete a las empresas exitosas de Guadalajara que utilizan Google Ads para crecer. Descubre cómo nuestras campañas personalizadas pueden llevar tu negocio local al próximo nivel.",
};
