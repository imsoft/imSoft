...
const introductorySectionInfo: IIntroductorySection = {
  title: "Especialistas en Consultoría Web en Guadalajara",
  description:
    "En imSoft, combinamos calidad y eficiencia para ofrecer soluciones de consultoría web que llevan a los negocios de Guadalajara al siguiente nivel en el mundo digital.",
};

const featuresSectionInfo: IFeaturesSection = {
  topic: "Consultoría Web Localizada en Guadalajara",
  title: "Características de Nuestro Servicio",
  description:
    "Ofrecemos un enfoque personalizado para maximizar el rendimiento y la productividad de su empresa en Guadalajara, con soluciones de software a medida.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Paquetes de Consultoría Web en Guadalajara",
  description:
    "Soluciones personalizadas de consultoría web para impulsar el crecimiento de tu negocio en Guadalajara.",
  listOfPackages: [
    {
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Consultoría Web Profesional en Guadalajara",
  title: "Eleva tu Negocio en Guadalajara con Nuestra Consultoría Web",
  description:
    "En imSoft, combinamos experiencia y conocimiento local para ofrecerte una consultoría web en Guadalajara que cumpla y exceda tus expectativas.",
};
