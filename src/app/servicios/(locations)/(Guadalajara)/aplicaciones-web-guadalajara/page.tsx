...
export const metadata: Metadata = {
  title: "Desarrollo de Aplicaciones Web en Guadalajara | imSoft",
  description:
    "En imSoft, creamos aplicaciones web personalizadas en Guadalajara para potenciar tu negocio. Mejora tu presencia online, interactúa eficazmente con tus clientes y automatiza tus procesos de negocio con nuestras soluciones web. Diseñamos aplicaciones escalables y adaptables para el futuro de tu empresa en Guadalajara.",
  keywords: [
    "imSoft",
  ...
  twitter: {
    title: "Desarrollo de Aplicaciones Web en Guadalajara por imSoft",
    description:
      "Descubre cómo imSoft puede transformar tu negocio en Guadalajara con aplicaciones web personalizadas. Aumenta tu presencia en línea y mejora la interacción con tus clientes con nuestras soluciones innovadoras.",
  },
  openGraph: {
    title: "Aplicaciones Web Personalizadas en Guadalajara | imSoft",
    description:
      "Con imSoft, lleva tu negocio en Guadalajara al siguiente nivel con aplicaciones web adaptadas a tus necesidades. Experiencia de usuario mejorada, escalabilidad y adaptabilidad para el futuro de tu empresa.",
  },
};

const introductorySectionInfo: IIntroductorySection = {
  title: "Desarrollo de Aplicaciones Web en Guadalajara",
  description:
...
const featuresSectionInfo: IFeaturesSection = {
  topic: "Aplicaciones Web en Guadalajara",
  title: "Características de Nuestro Servicio",
  description:
    "Eleva tu empresa en Guadalajara con aplicaciones web innovadoras que mejoran la eficiencia y la rentabilidad de tu negocio.",
  serviceFeatures: [
    {
...
const pricesSectionInfo: IPricesSection = {
  topic: "Soluciones de Aplicaciones Web en Guadalajara",
  description:
  ...
  listOfPackages: [
    {
      ...
      description:
        "Convierte tus ideas en realidad con soluciones a medida, diseñadas para el dinámico entorno empresarial de Guadalajara.",
      featuresOfPackage: [
        "Reunión inicial para alinear tus visiones y objetivos con las tendencias del mercado en Guadalajara.",
...
const callToActionSectionInfo: ICallToActionSection = {
  ...
  topic: "Soluciones Web Personalizadas en Guadalajara",
  title: "Impulsa tu Negocio en Guadalajara con Aplicaciones Web a Medida",
  description:
    "Descubre cómo nuestras aplicaciones web pueden revolucionar tu negocio en Guadalajara. Mejora tu presencia en línea, interactúa de manera más efectiva con tus clientes locales, y automatiza tus procesos de negocio para una mayor eficiencia. Con nuestras soluciones, garantizamos aplicaciones web escalables y flexibles, diseñadas para evolucionar junto a tu empresa y las demandas del mercado de Guadalajara.",
};

const WebAppPageGuadalajara = () => {
  return (
    <>
      <main>
        <IntroductorySection
