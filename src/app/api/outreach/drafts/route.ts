...
import { crearBorradorParaContacto, crearBorradoresPaso1 } from '@/lib/outreach-server'

export const maxDuration = 300

/** Genera borradores del primer correo: para un contacto (contactId) o en lote para prospectos sin contactar. */
